...
val elasticsearch8Version = "8.10.0"
...
lazy val `scio-smb`: Project = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.apache.parquet" % "parquet-avro" % parquetVersion % Provided excludeAll ("org.apache.avro" % "avro"), // scio-parquet
